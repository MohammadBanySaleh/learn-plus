                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a class="btn btn-primary btn-sm float-left" href="{{ route('teachers.create') }}">
                                        ...
                                        @foreach ($teachers as $teacher)
                                            ...
                                            <td class="project-actions">
                                                <div style="margin-bottom: 5px;">
                                                    <a class="btn btn-info btn-sm" href="{{ route('teachers.edit', $teacher->id) }}" style="width: 100%;">
                                                ...
                                                <div style="margin-bottom: 5px;">
                                                    <form action="{{ route('teachers.destroy', $teacher->id) }}" method="POST" style="display: inline;">
                                                        @method('DELETE')
                                                        @csrf
                                                        <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this teacher?')" style="width: 100%;">
