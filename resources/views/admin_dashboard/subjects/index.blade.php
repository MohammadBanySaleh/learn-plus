                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a class="btn btn-primary btn-sm float-left" href="{{ route('subjects.create') }}">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        @foreach ($subjects as $subject)
                                            ...
                                            <td><img src="{{ asset($subject->image) }}" alt="" width="100px" height="100px"></td>
