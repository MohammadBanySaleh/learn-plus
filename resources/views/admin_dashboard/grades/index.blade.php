                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a class="btn btn-primary btn-sm float-left" href="{{ route('grades.create') }}">
                                <i class="fas fa-user-plus"></i> Add New Grade
                            </a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                        ...
                                        @foreach ($grades as $grade)
                                            ...
                                            <td class="project-actions">
                                                <div style="margin-bottom: 5px;">
                                                    <a class="btn btn-info btn-sm" href="{{ route('grades.edit', $grade->id) }}" style="width: 100%;">
                                                ...
                                                <div style="margin-bottom: 5px;">
                                                    <form action="{{ route('grades.destroy', $grade->id) }}" method="POST" style="display: inline;">
                                                        @method('DELETE')
                                                        @csrf
                                                        <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this grade?')" style="width: 100%;">
