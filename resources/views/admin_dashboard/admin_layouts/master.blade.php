...
<head>
 ...
 @include('admin_dashboard.admin_layouts.head')
</head>
...
<div class="wrapper">
  ...
  @include('admin_dashboard.admin_layouts.main-headerbar')

  @include('admin_dashboard.admin_layouts.main-sidebar')
  ...
  <!-- /.content-wrapper -->
  @include('admin_dashboard.admin_layouts.footer')
  <!-- Control Sidebar -->
...
@include('admin_dashboard.admin_layouts.footer-scripts')
</body>
</html>
