...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="rs-plugin/css/A.settings.css.pagespeed.cf.xeOyGChsgq.css"
    media="screen" />
  ...
  <link rel="stylesheet" type="text/css"
    href="css/A.carousel.css%2bbxslider.css%2cMcc.jgeTii-u52.css.pagespeed.cf.STKSIMl7GF.css" />
  <link rel="stylesheet" type="text/css"
  ...
  <div id="wrapper">
        ...
        <div class="hovermenu ttmenu">
          <div class="navbar navbar-default" role="navigation">
            <div class="navbar-header">
              ...
              <div class="logo">
                <a class="navbar-brand" href="index-2.html"><img src="images/xlogo.png.pagespeed.ic.vap6Ukaf0i.png"
                    alt=""></a>
              </div>
            </div>
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                <li class="ttmenu-half"><a class="active" href="index.html">Home</a>
                ...
                <li class="ttmenu-half"><a href={{url('/courses')}}  
                    class="">Courses</a>
                ...
                <!-- <li><a href="page-about.html">Marks</a></li> -->
                <!-- <li><a href="page-about.html">About</a></li> -->
                <!-- <li class="dropdown ttmenu-half"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Features <b
                ...
                <li><a href="course-account.html">Profile</a></li>
                <li><a href="page-contact.html">Contact</a></li>
              </ul>
              <ul class="nav navbar-nav navbar-right">
                <!-- <li><a class="btn btn-primary" href="course-login.html"><i class="fa fa-sign-in"></i> Sign in</a> -->
                </li>
              </ul>
            </div>
          </div>
    ...
    <section class="slider-section">
      <div class="tp-banner-container">
        <div class="tp-banner">
          <ul>
            <li data-transition="fade" data-slotamount="1" data-masterspeed="500" data-thumb="upload/slider_new_03.jpg"
              data-saveperformance="off" data-title="Slide">
              <img src="upload/xslider_new_03.jpg.pagespeed.ic.0dDeZb1yS7.jpg" alt="fullslide1"
              ...
              <div class="tp-caption text-center lft tp-resizeme" data-x="center" data-y="440" data-speed="1000"
                ...
                style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;"> <a  href="course-login.html"
                  class="btn btn-primary">Login</a> <a target="_blank" href="course-login.html" class="btn btn-default">Read More
                  About</a>
              </div>
            </li>
            <li data-transition="fade" data-slotamount="1" data-masterspeed="500" data-thumb="upload/slider_new_01.jpg"
              data-saveperformance="off" data-title="Slide">
              ...
              <div class="tp-caption slider_layer_02 text-center lft tp-resizeme" data-x="center" data-y="320"
                data-speed="1000" data-start="800" data-easing="Power3.easeInOut" data-splitin="none"
                data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="1000"
                style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;">Learn Managment System
              </div>
              <div class="tp-caption text-center lft tp-resizeme" data-x="center" data-y="390" data-speed="1000"
                data-start="800" data-easing="Power3.easeInOut" data-splitin="none" data-splitout="none"
                data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="1000"
                style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;"><a href="course-login.html"
                  class="btn btn-default">Start Learning</a> <a href="course-login.html" class="btn btn-primary">Learn More</a>
              </div>
            </li>
            <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" data-delay="5000">
              <img src="images/xdummy.png.pagespeed.ic.lRMfmktUso.png" alt="video_business"
            ...
            <li data-transition="fade" data-slotamount="1" data-masterspeed="500" data-thumb="upload/slider_new_02.jpg"
              data-saveperformance="off" data-title="Slide">
    ...
    <!-- <section class="white section">
      <div class="container">
        ...
        <div class="row service-center">
          <div class="col-md-4 col-sm-6">
            <div class="feature-list border-radius">
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipiing elit. Integer loectetur adipiing elit. Integer
                lectetur adipiing elit. Integer lrem quam..</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="feature-list border-radius">
        ...
        <div class="callout row">
          <div class="col-md-9">
            <h4><i class="fa fa-graduation-cap fa-3x alignleft"></i> Lorem ipsum dolor sit amet, consectetur adipiscing
              elit. <a href="#">Vestibulum non</a><br> dolor ultricies, porttitor justo non.</h4>
          </div>
          <div class="col-md-3">
    ...
    <section class="section darkskin fullscreen paralbackground parallax"
      style="background-image:url(upload/xparallax_01.jpg.pagespeed.ic.JPVsQrTu6o.jpg)" data-img-width="1627"
        ...
        <div class="row service-center">
          <div class="col-md-4 col-sm-6">
            <div class="feature-list">
              <i class="fa fa-graduation-cap"></i>
              <p><strong>Multi-Tier Courses</strong></p>
              <p>Lorem ipsum m dolor sit amet, consectetur adipiing elit.dolor sit amet, consectetur adipiing elit.
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6">
            <div class="image-center wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
              <img src="upload/xdevice_02.png.pagespeed.ic.w5TutKGgkN.png" alt="" class="img-responsive">
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
                ...
                <div class="textrotate">
                  <ul class="bxslider">
                    <li>
                      ...
                      <p>Phasellus nec dolor.Sed ornare semper ipsum. Sed pede orci volutpat sed congue vels gravida non
                        lacus.Vivamus quis sed metus quisque gravida Quisque blandit sem esed erat. Maecenas porttitor
                        neque eu sem. Nullam lectus neque, blandit quis mattis quis varius eu eros. Vivamus ads metus.
            ...
            <div class="content-widget">
              <div class="team-members row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="team">
                    <img src="upload/xteam_01.jpg.pagespeed.ic.uNKwi9Xmie.jpg" alt=""
                      class="img-responsive wow fadeInUp">
                    <div class="team-hover-content">
                      <h5>Bryan Kennedy</h5>
                      <span>Project Manager</span>
                      <p>Curabitur ultrices nec est nec vestibulum. Maecenas tincidunt pretium lacinia. Nullam purus
                        dolor, tempor et lacinia quis, viverra quis erat.</p>
                      <div class="social">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="team">
                    <img src="upload/xteam_02.jpg.pagespeed.ic.Foo3PN64df.jpg" alt=""
                      class="img-responsive wow fadeInUp">
                    <div class="team-hover-content">
                      <h5>Adam DEO</h5>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="team">
                    <img src="upload/xteam_03.jpg.pagespeed.ic.Mw22RnI1eL.jpg" alt=""
                      class="img-responsive wow fadeInUp">
                    <div class="team-hover-content">
                      <h5>Jenny Kennedy</h5>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="team">
                    <img src="upload/xteam_04.jpg.pagespeed.ic.equz9NTtM1.jpg" alt=""
                      class="img-responsive wow fadeInUp">
                    <div class="team-hover-content">
                      <h5>Jennifer DEO</h5>
        ...
        <div class="row blog-widget">
          <div class="col-md-4 col-sm-6">
            <div class="blog-wrapper">
              ...
              <div class="blog-image">
                <a href="single.html" title=""><img src="upload/xblog_01.jpg.pagespeed.ic.2jVY1j1OMe.jpg" alt=""
                    class="img-responsive"></a>
              </div>
              <div class="blog-desc">
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
                  industry's standard dummy text ever since theown printer took.</p>
          ...
          <div class="col-md-4 col-sm-6">
            <div class="blog-wrapper">
              ...
              <div class="blog-image">
                <a href="single.html" title=""><img src="upload/xblog_02.jpg.pagespeed.ic.VhhhBexs2E.jpg" alt=""
                    class="img-responsive"></a>
              </div>
              <div class="blog-desc">
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
          ...
          <div class="col-md-4 col-sm-6">
            <div class="blog-wrapper">
              ...
              <div class="blog-image">
                <a href="single.html" title=""><img src="upload/xblog_03.jpg.pagespeed.ic.ZGQLz9XvWC.jpg" alt=""
                    class="img-responsive"></a>
              </div>
              <div class="blog-desc">
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
        ...
        <div class="row">
          <div class="col-md-3 col-md-6 col-xs-12">
            <div class="widget">
              ...
              <p>LearnPlus is an innovative and comprehensive eLearning platform that empowers learners of all backgrounds to embark on a journey of knowledge and skill acquisition. With its user-friendly interface and diverse range of courses, LearnPlus offers a seamless learning experience that caters to individuals seeking to expand their horizons.</p>
