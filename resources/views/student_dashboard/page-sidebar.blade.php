...
<head>
  ...
  <link rel="stylesheet" href="./singleCourse.css">
  <link rel="stylesheet"
          ...
          <div class="navbar navbar-default" role="navigation">
            ...
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                <li class="ttmenu-half"><a href="index.html">Home</a>
                ...
                <li class="ttmenu-half"><a href="course-grid.html" 
                    class="active">Courses</a>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li><a class="btn btn-primary" href="course-login.html"><i class="fa fa-sign-in"></i> Logout</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="row">
          <div id="sidebar" class="col-md-4 col-sm-4 col-xs-12">
            <div class="widget">
              <div class="widget-title">
                <h4>Guidlines & Pins</h4>
                <hr>
              </div>
              <div>
                <ul>
                  <li>
                    <a href="#" style="font-size: 20px;">Syllabus.pdf</a>
                  </li>
                  <li>
                    <a href="#" style="font-size: 20px;">Textbook.pdf</a>
                  </li>
                  <li>
                    <a href="#" style="font-size: 20px;">Zoom Link</a>
                  </li>
                </ul>
              </div>
            </div>
            <div class="widget">
              ...
              <div>
                <ul>
                  <li>
                    <a href="#" style="font-size: 20px;">Topic 1</a>
                  </li>
                  <li>
                    <a href="#" style="font-size: 20px;">Topic 2</a>
                  </li>
                  <li>
                    <a href="#" style="font-size: 20px;">Topic 3</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div id="content" class="col-md-8 col-sm-8 col-xs-12">
            <div class="wm-courses-started">
              <div class="topicNameDiv">
                <h2 class="topicName" style="padding: 5px;">Topic 1: Light - Reflection and Reflaction</h2>
              </div>
              <ul class="contentList">
                <li>
                  <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/A4jseVHjI_4"
                      allowfullscreen></iframe>
                  </div>
                </li>
                <li>
                  <div class="icon_text_list_item">
                    <span class="material-symbols-outlined">
                      assignment
                    </span>
                    <a href="quizLanding.html">Quiz 1: Reflection & Refraction</a>
                  </div>
                </li>
                <li>
              ...
              <div class="topicNameDiv">
                <h2 class="topicName" style="padding: 5px;">Topic 2: Electricity </h2>
              </div>
              <div class="text-content">
                <p>In this chapter we will know about: </p>
                <ul>
                  <li>2.1: Electric Current and Electric Potential</li>
                  <li>2.2: Heating Effect of Electric Current</li>
                  <li>2.3: Ohm's Law and Resistance</li>
                  <li>2.4: Resistors in Series and Parallel</li>
                </ul>
                <p><span style="text-decoration: underline">Note: </span>This topic requires a lot of focus and practice
                  so always follow up with the assignments and quizzes .</p>
              </div>
              <div class="subTopic">
                <h3>2.1: Electric Current and Electric Potential:</h3>
