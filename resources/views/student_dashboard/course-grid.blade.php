...
<head>
  ...
  <!--[if lt IE 9]>
    ...
    <![endif]-->
  <link rel="stylesheet" href="./coursesGrid.css">
</head>
          ...
          <div class="navbar navbar-default" role="navigation">
            ...
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                <li class="ttmenu-half"><a href={{url('/')}}>Home</a>
                          ...
                          <div class="col-md-6">
                            <div class="box">
                              <ul>
                                ...
                                <li><a href={{url('/courses')}} >Courses Grid</a></li>
      ...
      <div class="container">
        <div class="row course-list">
          <div class="col-md-3 col-sm-6 col-xs-12 first">
            <a href={{url('singleCourse')}}>
              <div class="shop-item-list entry cDiv">
                <div class="cimgDiv">
                  <img class="cimg" src="images/math.png" alt="">
                  <div class="magnifier">
                  </div>
                </div>
                <div class="shop-item-title clearfix">
                  <h4 class="cName"><a href={{url('singleCourse')}}>Mathematics</a></h4>
                  <div class="shopmeta">
                    <!-- <span class="pull-left">grade 10, first semister</span> -->
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="shop-item-list entry cDiv">
              <div class="cimgDiv">
                <img class="cimg" src="images/—Pngtree—atomic chemistry icon_6952358.png" alt="">
                <div class="magnifier">
                </div>
              </div>
              <div class="shop-item-title clearfix">
                <h4 class="cName"><a href="course-single.html">Physics</a></h4>
                <div class="shopmeta">
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="shop-item-list entry cDiv">
              <div class="cimgDiv">
                <img class="cimg" src="images/chemical.png" alt="">
                <div class="magnifier">
                </div>
              </div>
              <div class="shop-item-title clearfix">
                <h4 class="cName"><a href="course-single.html">Chemistry</a></h4>
                <div class="shopmeta">
          ...
          <div class="col-md-3 col-sm-6 col-xs-12 last">
            <div class="shop-item-list entry cDiv">
              <div class="cimgDiv">
                <img class="cimg" src="images/biology.png" alt="">
                <div class="magnifier">
                </div>
              </div>
              <div class="shop-item-title clearfix">
                <h4 class="cName"><a href="course-single.html">Biology</a></h4>
                <div class="shopmeta">
                  <!-- <span class="pull-left">98 Student</span>
                  <div class="rating pull-right">
                    <i class="fa fa-star"></i>
